...
![](https://phinf.wevpstatic.net/MjAyNDAyMDdfMTUw/MDAxNzA3Mjk0MzM1Nzg3\.QYjk0YAuAoX7Ho865Igw3ldM_De6PNmzN_fs05djAOIg.BrxOg8ACv5VdyYkpMp5KjMwabnnCrlaJHf72eECDhZkg.JPEG/image.jpg?type=e1920){ loading=lazy onclick="openFullscreen(this)"}
...
<div markdown="1">
<figure class="msg-media" markdown="1">
![](https://phinf.wevpstatic.net/MjAyNDAyMDlfNDMg/MDAxNzA3NDc2Njg0OTY1\.D2DaacGhkwjlu-p-Il8bu-xqnLKn6WQrlaWJtlVuCqAg.Sr5i3Dqf2mhRK9SJ6mywFun4I9Hji6ybj8mvabwZsFMg.JPEG/image.jpg?type=e1920){ loading=lazy onclick="openFullscreen(this)"}
</figure>
</div>
</div>
<div class="message" markdown="1">
...
<div markdown="1">
그래그래 발렌타인 17년산을 마시던 발렌타인 에디션을 사던
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div class="no-flex" markdown="1">
암튼 난 달달한킬리안 love don't be shy extreme 뿌리고 잔다
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
ㅋㅋㅋㅋㅋ ㅋ ㅋ ㅋ ㅋ ㅋ ㅋ ㅋㅋㅋㅋ당근아 죽어줘래 ㅋㅋㅋㅋㅋㅋ
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
그래서 샌드위치며 오믈렛이며 단기간에 많이 먹을 것 같아서
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div class="no-flex" markdown="1">
지금 유튜브 알고리즘으로후지이 카제 - kirari 나오는데
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
밥+볶은양배추+우삼겹+아보카도+계란+명란 비벼먹음 맛있어
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
이제 난 명란 파스타 명란 비빔장 명란구이에 미쳐있을거여
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
1\. 신선한 명란을 산다<br>2\. 그래도 비리면 구워먹는다<br>(한번 물에 데치고, 청주에 잠시 재우고, 버터에 구우세요)
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
아니면 껍질 벗겨서 참기름 다진마늘 다진파 깨 고춧가루 뭐 해서 한번 기름장처럼 만들어서 비벼먹어여
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
...
<div markdown="1">
ㅋㅋㅋ ㅋ ㅋ  ㅋ ㅋ ㅋㅋ ㅋ 또 다른 팁 플로버가 알려줌
</div>
</div>
<div class="message" markdown="1">
<div class="message-date" markdown="1">
